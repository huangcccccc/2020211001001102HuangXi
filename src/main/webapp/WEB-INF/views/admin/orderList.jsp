			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.huangxi.model.Order o=(com.huangxi.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.huangxi.dao.UserDao userDao=new com.huangxi.dao.UserDao();
						...
						<%
							...
							String paymentType=com.huangxi.model.Payment.findByPaymentId(con,n);
							 %>
